<section class="col-lg-12">
		<header class="clearfix">
			<section class="branding">
				<a href="index.php"><img src="images/misc/mojo_logo.png" class="img-responsive" alt="logo for mojo app"></a>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
	          <li><a href="#">Explain-Packages!</a></li><!-- slide in modal to come top right down-->
